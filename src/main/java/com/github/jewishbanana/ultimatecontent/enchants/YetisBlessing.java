...
public class YetisBlessing extends CustomEnchant {
	...
	public static final List<Material> applicableTypes = new ArrayList<>(Arrays.asList(Material.LEATHER_CHESTPLATE, Material.CHAINMAIL_CHESTPLATE, Material.IRON_CHESTPLATE, Material.GOLDEN_CHESTPLATE, Material.DIAMOND_CHESTPLATE, Material.NETHERITE_CHESTPLATE));
	static {
		Material copperChestplate = Material.getMaterial("COPPER_CHESTPLATE");
		if (copperChestplate != null)
			applicableTypes.add(1, copperChestplate);
	}
