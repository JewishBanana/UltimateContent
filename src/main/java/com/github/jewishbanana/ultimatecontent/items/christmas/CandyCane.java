...
public class CandyCane extends Weapon {

	public static final String REGISTERED_KEY = "uc:candy_cane";
	
	public CandyCane(ItemStack item) {
		super(item);
	}
	@Override
	public ItemBuilder createItem() {
		return CustomItemBuilder.create(getType(), Material.DIAMOND_SWORD).assembleLore().setCustomModelData(100019).build();
	}
	public static void register() {
		UIItemType.registerItem(REGISTERED_KEY, CandyCane.class);
	}
