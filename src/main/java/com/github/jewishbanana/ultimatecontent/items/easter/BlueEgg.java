...
public class BlueEgg extends BaseItem {
	
	public static final String REGISTERED_KEY = "uc:blue_egg";

	public BlueEgg(ItemStack item) {
		super(item);
	}
	@Override
	public ItemBuilder createItem() {
		return CustomItemBuilder.create(getType(), Material.TURTLE_EGG).assembleLore().setCustomModelData(100024).build();
	}
	public static void register() {
		UIItemType.registerItem(REGISTERED_KEY, BlueEgg.class);
	}
