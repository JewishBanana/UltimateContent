...
public class BunnyHop extends CustomEnchant {
	...
	public static String REGISTERED_KEY = "ui:bunny_hop";
	public static List<Material> applicableTypes = Arrays.asList(Material.LEATHER_BOOTS, Material.CHAINMAIL_BOOTS, Material.IRON_BOOTS, Material.GOLDEN_BOOTS, Material.DIAMOND_BOOTS, Material.NETHERITE_BOOTS);
	
	public static NamespacedKey bunnyHopParticleKey = new NamespacedKey(plugin, "ui-bhpk");
	
	public BunnyHop(String registeredName, int id) {
