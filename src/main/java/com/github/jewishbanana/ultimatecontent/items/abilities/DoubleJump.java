...
public class DoubleJump extends AbilityAttributes {
	...
	public static String REGISTERED_KEY = "ui:double_jump";
	...
	public void activate(Entity entity, GenericItem base) {
        ...
        entity.getWorld().playSound(entity.getLocation(), Sound.ENTITY_RABBIT_JUMP, SoundCategory.PLAYERS, 20f * volume, 0.8f);
	...
	public static void register() {
		AbilityType.registerAbility(REGISTERED_KEY, DoubleJump.class);
	}
